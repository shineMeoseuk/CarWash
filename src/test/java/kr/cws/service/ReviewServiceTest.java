...
class ReviewServiceTest {
    ...
    public void getReviewsWhenSuccess() {
        ...
        verify(reviewMapper).selectReviewsByCarWashId(2L);
    }
    ...
    public void updateReviewWhenFail() {
        ...
        assertThrows(NotFoundException.class, () -> reviewService.updateReview(reviewReq, 1L, 2L));
        verify(reviewMapper).updateReview(any(Review.class));
    }
    ...
    public void deleteReviewWhenFail() {
        ...
        assertThrows(NotFoundException.class, () -> reviewService.deleteReview(1L, 2L));
        verify(reviewMapper).deleteReview(1L, 2L);
    }
}
